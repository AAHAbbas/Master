...
public class AssetManager {
    ...
    public void loadConceptConfiguration() throws Exception {
        ...
        cc = new ConceptConfiguration(npdOntology, "config-npd-wellbore-1-1");
        c1 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Wellbore");
        cc.setRoot(c1);
        ...
        c1 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Wellbore");
        c2 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Field");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore_inverseProp", c2);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToAllVariables();
        configs.put(cc.getId(), cc);
        ...
        c1 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Wellbore");
        c2 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Field");
        c3 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Company");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore_inverseProp", c2);
        cc.addEdge(c2, "http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator", c3);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToAllVariables();
        configs.put(cc.getId(), cc);
        ...
        c2 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Field");
        c3 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Company");
        c4 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Pipeline");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore_inverseProp", c2);
        cc.addEdge(c2, "http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator", c3);
        cc.addEdge(c3, "http://sws.ifi.uio.no/vocab/npd-v2#pipelineOperator_inverseProp", c4);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToAllVariables();
        configs.put(cc.getId(), cc);
        ...
        c3 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Company");
        c4 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Pipeline");
        c5 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#WellboreDocument");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore_inverseProp", c2);
        cc.addEdge(c2, "http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator", c3);
        cc.addEdge(c3, "http://sws.ifi.uio.no/vocab/npd-v2#pipelineOperator_inverseProp", c4);
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#documentForWellbore_inverseProp", c5);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToAllVariables();
        configs.put(cc.getId(), cc);
        ...
        c1 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Wellbore");
        c2 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Discovery");
        c3 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Field");
        c4 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Company");
        c5 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#BAA");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore_inverseProp", c2);
        cc.addEdge(c2, "http://sws.ifi.uio.no/vocab/npd-v2#includedInField", c3);
        cc.addEdge(c3, "http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator", c4);
        cc.addEdge(c4, "http://sws.ifi.uio.no/vocab/npd-v2#baaOperatorCompany_inverseProp", c5);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToAllVariables();
        configs.put(cc.getId(), cc);

        // expwellbore used to debug
        cc = new ConceptConfiguration(npdOntology, "config-npd-expwellbore-1-1");
        c1 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#ExplorationWellbore");
        c2 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Field");
        c3 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicence");
        c4 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Company");
        c5 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#FieldStatus");
        c6 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#Discovery");
        c7 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#ProductionlicenceStatus");
        c8 = new ConceptVariable(cc.genVarId(), "http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceArea");
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#explorationWellboreForField", c2);
        cc.addEdge(c1, "http://sws.ifi.uio.no/vocab/npd-v2#explorationWellboreForLicence", c5);
        cc.addEdge(c2, "http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator", c3);
        cc.addEdge(c4, "http://sws.ifi.uio.no/vocab/npd-v2#statusForField", c2);
        cc.addEdge(c8, "http://sws.ifi.uio.no/vocab/npd-v2#includedInField", c2);
        cc.addEdge(c6, "http://sws.ifi.uio.no/vocab/npd-v2#statusForLicence", c5);
        cc.addEdge(c7, "http://sws.ifi.uio.no/vocab/npd-v2#isGeometryOfFeature", c5);
        cc.setRoot(c1);
        cc.addAllMissingDatatypePropertiesToVariable(c1);
        configs.put(cc.getId(), cc);
    }
