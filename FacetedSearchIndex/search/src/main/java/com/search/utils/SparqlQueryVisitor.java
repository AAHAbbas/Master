...
public class SparqlQueryVisitor extends QueryModelVisitorBase {
    ...
    DirectedGraph<Variable, LabeledEdge> directedGraph = new DirectedMultigraph<Variable, LabeledEdge>(
    ...
    public SparqlQueryVisitor(String SPARQLQuery) throws Exception {
        ...
        // Visit. This stores all the useful information in regexFilters, compareFilters
        // and statementPatterns.
